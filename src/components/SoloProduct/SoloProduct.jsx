            ...
            <div className="soloproduct_content">
                <div className="solo_sec1">
                    ...
                    <div className="soloproduct_info">
                        ...
                        <div className="soloproduct_price soloproduct_common_font">You Save: <span className="original_pri">₹20.00</span></div>
                        <div className="soloproduct_iteam_varients"><IteamBox /></div>
                        <div className="soloproduct_btns_con">
                            <div className="soloproduct_Buy_btn_con"><div className="soloproduct_Buy_btn">Buy Now</div></div>
                            <div className="soloproduct_Buy_btn_con"><div className="soloproduct_Buy_btn">Add To Cart</div></div>
                        </div>
                        <div className="soloproduct_service">
                            <div className="soloproduct_service_title">Service <div className="soloproduct_line" /></div>
                            <div className="soloproduct_service_icons">
                                <div className="soloproduct_service_icon extra_border_left">
                                    ...
                                    <div className="soloproduct_high_text soloproduct_high_text_extra">20 Min </div>
                                ...
                                <div className="soloproduct_service_icon extra_border">
                                    ...
                                    <div className="soloproduct_high_text soloproduct_high_text_extra">Cash</div>
                                    <div className="soloproduct_high_text_nor">On Delivry</div>
                                </div>
                                <div className="soloproduct_service_icon extra_border_right">
                                    <AccountBalanceIcon style={{fontSize:55,color:"#4AC85D"}}/>
                                    <div className="soloproduct_high_text soloproduct_high_text_extra">Online Payment</div>
            ...
            <div className="soloproduct_service">
              ...
              <div className="soloproduct_service_icons">
                <div className="soloproduct_service_icon extra_border_left">
                  ...
                  <div className="soloproduct_high_text_nor">Delivery Time</div>
>>>>>>> ba89799b2ca5717b9363908399bba6bc3b5f673e
                </div>
                <div className="soloproduct_service_icon extra_border">
                  <MoneyIcon style={{ fontSize: 55, color: "#4AC85D" }} />
                  <div className="soloproduct_high_text soloproduct_high_text_extra">
