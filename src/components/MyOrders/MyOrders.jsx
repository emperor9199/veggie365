  ...
  return (
    <div className="MyOrders_container">
      <div className="product_prders">
        <div className={size > 720 ? "starproducts_head_title" : "starproducts_head_title_phone"}>
          {size > 720 ? "Your Orders" : <div className="pill_class">
              <div className={`pill_class_my pill_class_active_left ${active === "my" ? "pill_class_active" : "" }`} onClick={() => setActive("my")}>My Orders</div>
              <div className={`pill_class_my pill_class_active_right ${active === "cab" ? "pill_class_active" : "" }`} onClick={() => setActive("cab")}>Cab Orders</div>
            </div>}
        </div>
