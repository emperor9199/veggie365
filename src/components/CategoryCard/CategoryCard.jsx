...
function CategoryCard() {
  return <div className="CategoryCard_Container">
          ...
          CategoryCardDatas.map((categorycarddata) => {
              return(
                <div className="categorycard_card" key={categorycarddata.id}>
                    <img src={categorycarddata.img} alt={categorycarddata.text} className="categorycard_img"/>
                    <span className="categorycard_card_text">{categorycarddata.text}</span>
                </div>
              )  
          })
      }   
